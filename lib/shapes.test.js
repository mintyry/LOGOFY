//  require shapes.js to make new instances of each shape to test against to ensure they will pass and render method works.
const { Triangle, Circle, Square } = require('./shapes.js')

// describe suite tests to see if .render() method works.
